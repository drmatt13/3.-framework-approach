...
parser.add_argument("--solver", type=_lower_token, choices=LOGISTIC_SOLVERS, default="{{LOGISTIC_SOLVER_DEFAULT}}")
parser.add_argument("--penalty", type=_lower_token, choices=LOGISTIC_PENALTIES, default="{{LOGISTIC_PENALTY_DEFAULT}}")
parser.add_argument("--class-weight", type=_lower_token, choices=["none", "balanced"], default="{{LOGISTIC_CLASS_WEIGHT_DEFAULT}}")
