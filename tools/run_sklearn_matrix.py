	...
	cases: list[MatrixCase] = [
		MatrixCase(
			...
			generate_args=[
				...
				"--default-lr-enable-tuning", "false",
			],
		...
		MatrixCase(
			...
			generate_args=[
				...
				"--default-lr-penalty", "auto",
				"--default-lr-tuning-method", "random",
				"--default-lr-cv-folds", "3",
				"--default-lr-cv-n-iter", "4",
				"--default-lr-cv-n-jobs", "-1",
			],
			train_args=["--save-model=true", "--verbose", "0", "--artifact-name-mode", "short"],
		),
		MatrixCase(
			...
			generate_args=[
				...
				"--default-logistic-enable-tuning", "false",
			],
			train_args=["--save-model=true", "--verbose", "0", "--artifact-name-mode", "short"],
		),
		MatrixCase(
			...
			generate_args=[
				...
				"--default-logistic-tuning-method", "random",
				"--default-logistic-cv-folds", "3",
				"--default-logistic-cv-n-iter", "4",
				"--default-logistic-cv-n-jobs", "-1",
			],
			train_args=["--save-model=true", "--verbose", "0", "--artifact-name-mode", "short"],
		),
		MatrixCase(
		...
		MatrixCase(
			...
			generate_args=[
				...
				"--task", "regression",
				"--starter-dataset", "insurance.csv",
				"--default-rf-enable-tuning", "false",
			],
			train_args=["--save-model=true", "--verbose", "0", "--artifact-name-mode", "short"],
		),
		MatrixCase(
			...
			generate_args=[
				...
				"--task", "regression",
				"--starter-dataset", "insurance.csv",
				"--default-rf-enable-tuning", "true",
				"--default-rf-tuning-method", "random",
				"--default-rf-cv-folds", "3",
				"--default-rf-cv-n-iter", "4",
				"--default-rf-cv-n-jobs", "-1",
			],
			train_args=["--save-model=true", "--verbose", "0", "--artifact-name-mode", "short"],
		),
		MatrixCase(
